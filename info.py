...
PICS = (environ.get('PICS', 'https://te.legra.ph/file/f0a95bd9a420e6e1296fb.jpg')).split()
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Rider9:2442339024@cluster0.ini1poa.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Owner5g')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "False")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "\n⚙️ <b>Size: </b><i>{file_size}</i>\n\n                ❤️<b>Please support us</b>❤️\n🔥  ↭ <b>Join Now [Mad_cinema](https://t.me/Mad_cinema)</b> ↭  🔥")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", CUSTOM_FILE_CAPTION)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b> powered by: @Mad_cinema \n\n🏷 Title: <a href={url}>{title}</a>\n")
...
LAZY_AI_LOGS = int(environ.get("LAZY_AI_LOGS","-1001983121584")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of LazyPrincess ]
# Requested Content template variables ---
ADMIN_USRNM = environ.get('ADMIN_USRNM','Owner5g') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','Owner5g') # WITHOUT @
...
URL_SHORTENR_WEBSITE = environ.get('URL_SHORTENR_WEBSITE', 'madxlinks.c1.is') #Always use website url from api section 
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '917f5e18e3a887e230398686795ec8bef0ce5128')
...
BOT_USERNAME = environ.get('BOT_USERNAME' ,'Oggy5gbot' )
